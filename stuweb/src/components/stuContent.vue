    ...
    <div id="stuContent">
        <div class="top">
            ...
            <div class="msg">
                ...
                <div class="dept">{{ studentMsg.dept_name }} {{studentMsg.major_name}}</div>
            </div>
        </div>
        ...
        <el-card class="box-card" shadow="hover">
            <div slot="header" class="clearfix">
                <span>成绩</span>
                <el-button style="float: right; padding: 3px 0" type="text" @click="$router.push('/stugrade')">更多</el-button>
            </div>
            <div v-for="item in courseMsg.slice(0,5)" :key="item.course_id" class="text item">
                <div class="score">
